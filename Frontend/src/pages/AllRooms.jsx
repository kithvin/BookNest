...
// Main AllRooms Component

const AllRooms = () => {
  const navigate = useNavigate();
  const [openFilters, setOpenFilters] = useState(false); // Toggle filter section on small screens
    ...
    >
      ...
      {/* Filters Header */}
        ...
        >
          ...
          {/* Toggle Button for Mobile / Clear Button for Desktop */}
